...
function FooterNav() {
  return (
    <>
      <div className="mx-auto w-full max-w-screen-xl text-white text-center text-2xl border-t-2 border-neutral-500 p-4">
        <ul className="flex items-center justify-center">
          <li>
            <Link to="https://www.linkedin.com/in/desiree-mezzotero-a836a9351/">
              <i class="fa-brands fa-linkedin mr-5"></i>
            </Link>
          </li>
          <li>
            <Link to="https://gist.github.com/desireemezzotero">
              <i class="fa-brands fa-github mr-5"></i>
            </Link>
          </li>
          <li>
